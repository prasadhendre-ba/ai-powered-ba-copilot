...
import { ActivityDiagramSvg } from "@/components/artifacts/ActivityDiagramSvg";
...
async function exportPng(svgEl: SVGSVGElement | null, filename: string) {
  if (!svgEl) throw new Error("Diagram not ready");
  const vb = svgEl.viewBox.baseVal;
  const w = vb.width || 880;
...
async function exportPdf(svgEl: SVGSVGElement | null, title: string, narrative: string[]) {
